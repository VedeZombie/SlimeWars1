...
public class SlimeWars : PhysicsGame
{
    ...
    Image pelaajanKuva = LoadImage("slimekiller");

    Image tahtiKuva = LoadImage("coin2");
    ...
    void LuoKentta()
    {
        ...
        Level.CreateBorders();
        Level.Background.CreateGradient(Color.Purple, Color.Blue);
    }
    ...
    void LisaaPelaaja(Vector paikka, double leveys, double korkeus)
    {
        ...
        AddCollisionHandler(pelaaja1, "coin", TormaaTahteen);
        Add(pelaaja1);
    }
